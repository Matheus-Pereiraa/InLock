...
namespace senai_InLock_WebApi.Repositories
{
    ...
    {
        //private string stringConexao = @"Data Source=DESKTOP-194G6KK\SQLEXPRESS; initial catalog=InLock; user Id=sa; pwd=senai@132;";
        private string stringConexao = @"Data Source=Ashuala\SQLEXPRESS; initial catalog=InLock; user Id=sa; pwd=senai@132";
        public void AtualizarIdCorpo(UsuarioDomain usuarioAtualizado)
        {
            if (usuarioAtualizado.nome != null)
            {
                using (SqlConnection con = new SqlConnection(stringConexao))
                {
                    ...
                    {
                        cmd.Parameters.AddWithValue("@NomeUsuario", usuarioAtualizado.nome);
                        cmd.Parameters.AddWithValue("@EmailUsuario", usuarioAtualizado.email);
                        cmd.Parameters.AddWithValue("@SenhaUsuario", usuarioAtualizado.senha);
